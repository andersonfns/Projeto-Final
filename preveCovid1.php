...
<head lang="pt-br">
    ...
    <title>Espaço Saúde|Prevenção da covid-19</title>
    <meta name='viewport' content='width=device-width, initial-scale=1'>
    <link rel='stylesheet' type='text/css' media='screen' href='css/styleCp.css' href="js/menupreve1.js"> <!--CSS da página -->
 ...
 <body>
            ...
            <!--Nome do site e slogan -->
              ...
              <h1 class="fundo-letra">Prevenção ao Vírus</h1>
...
<center>                                                        
  ...
  <br>
  <p> Procure atendimento médico se tiver febre, tosse e dificuldade para respirar.</p> <p>Ligue com antecedência para o órgão prestador de cuidados de saúde e 
...
<article class="contenedor-fg"> 
  ...
  <br>
  <p> De acordo com os protocolos de prevenção ao coronavírus, os cidadãos devem ficar atentos aos sintomas e não descumprirem os protocolos de cuidados e prevenção à Covid-19, evitando aglomerações familiares, festas particulares, circulação em locais de risco - principalmente as pessoas com comorbidades.</p>
  <br>
  </article>
  ...
  <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Covid-19
  </h4>
  <br>
  <p> A maioria das pessoas que adoece em decorrência da COVID-19 apresenta sintomas leves a moderados e se recupera sem tratamento especial. No entanto, algumas desenvolvem um quadro grave e precisam de atendimento médico.</p>
  </article>
...
<div class="container">
  <svg id="circle-nav-services" width="100%" height="100%" viewBox="0 0 650 550">
    ...
    <symbol id="circle-nav-copy" viewBox="0 0 300 300">
      ...
      <!--Menu prevenção covid text dos elementos circle-->
      ...
      <text class="cls-5" transform="translate(57 1930)">Em caso de suspeita ou aparição
        <tspan class="cls-6" x="38" y="0"></tspan>
        <tspan x="43" y="0"> </tspan>
        <tspan class="cls-3" x="1" y="19">de sintomas do vírus, não se</tspan>
        ...
        <tspan x="1" y="38">autodiagnostique pois alguns</tspan>
      ...
      <text class="cls-5" transform="translate(47 1636)">
        <tspan class="cls-13">Cubra o nariz e a boca com o braço</tspan>
        ...
        <tspan x="0" y="19"> dobrado ou um lenço ao tossir ou  </tspan>
        <tspan x="0" y="38">espirrar. </tspan>
      ...
      <!--Local-->
      <text class="cls-1" transform="translate(105 966)">Locais
        <tspan class="cls-2" x="18" y="0"></tspan>
        <tspan x="28" y="0"></tspan>
        <tspan x="-48" y="28">(aglomerações)</tspan>
      </text>
      <text class="cls-5" transform="translate(65 1037)">
        <tspan class="cls-13"></tspan>
        <tspan x="-23" y="0">Prefira locais abertos e bem venti- </tspan>
        <tspan class="cls-11" x="61" y="0"></tspan>
        <tspan x="68" y="0"></tspan>
        <tspan class="cls-8" x="122" y="0"></tspan>
        <tspan x="127" y="0"> </tspan>
        <tspan x="-23" y="19">lados, abra uma janela se estiver </tspan>
        <tspan class="cls-6" x="93" y="19"></tspan>
        <tspan x="98" y="19"> </tspan>
        <tspan x="-23" y="38">em um local fechado. 📍 </tspan>
        <tspan x="-23" y="58"> </tspan>
      ...
      <!--vacina-->
      <text class="cls-1" transform="translate(85 666)">Vacinação</text>
      <text class="cls-5" transform="translate(83 710)">
        <tspan class="cls-7" x="-27" y="0">Tome a vacina quando chegar</tspan>
        <tspan x="42" y="0"> </tspan>
        <tspan x="-27" y="19"> a sua vez, siga as orientações </tspan>
        <tspan class="cls-6" x="-18" y="19"></tspan>
        <tspan x="-13" y="19"> </tspan>
        <tspan x="-27" y="38"> locais para isso. Certifique-se</tspan>
        <tspan class="cls-11" x="129" y="38"></tspan>
        <tspan class="cls-15" x="138" y="38"></tspan>
        <tspan x="145" y="38"> </tspan>
        <tspan x="-27" y="58">de todas as contraindicações</tspan>
        <tspan x="-27" y="77">antes de tomar a vacina. 💉  </tspan>
      ...
      <!--Máscara-->
      <text class="cls-1" transform="translate(90 70)">Máscara</text>
      <text class="cls-5" transform="translate(50 108)"> 😷 Use máscara em público
        <tspan x="1" y="19">   especialmente </tspan>
        <tspan class="cls-6" x="71" y="19"></tspan>
        <tspan x="90" y="19">. em locais com </tspan>
        <tspan class="cls-8" x="-1" y="38"></tspan>
        <tspan x="1" y="38">pouca ventilação ou quando  </tspan>
        <tspan x="1" y="58">não for possível manter o</tspan>
        ...
        <tspan x="1" y="77">distânciamento físico sempre. </tspan>
      ...
      <text class="cls-1" transform="translate(87 365)">
        ...
        <tspan x="18" y="0">Médico</tspan>
        <tspan x="-10" y="28">Profissional</tspan>
        <tspan class="cls-18" x="130" y="28"></tspan>
        <tspan x="149" y="28"></tspan>
      </text>
      <text class="cls-5" transform="translate(46 437)">Ligue com antecedência para o 
        <tspan class="cls-19" x="40" y="0"></tspan>
        <tspan x="46" y="0"></tspan>
        <tspan class="cls-19" x="173" y="0"></tspan>
        <tspan x="178" y="0"> </tspan>
        <tspan x="1" y="19">órgão prestador de cuidados de</tspan>
        <tspan class="cls-6" x="34" y="19"></tspan>
        <tspan class="cls-11" x="39" y="19"></tspan>
        <tspan x="48" y="19"></tspan>
        <tspan x="0" y="38">saúde e 
          peça direcionamento à  </tspan>
        <tspan x="2" y="58">unidade mais adequada. ⚕️ </tspan>
      ...
      <text class="cls-5" transform="translate(47 1323)">Limpe as mãos com frequência
        <tspan class="cls-6" x="146" y="0"></tspan>
        <tspan x="154" y="0"></tspan>
        <tspan x="0" y="19"> use sabão e água ou álcool em  </tspan>
        <tspan x="0" y="38">gel, retirar a máscara sempre  </tspan>
        <tspan class="cls-7" x="0" y="58">pelas alças. </tspan>
        <tspan x="0" y="58"> </tspan>
        <tspan x="-1" y="77">Tirar os sapatos quando entrar em </tspan>
        <tspan x="0" y="96">sua casa e deixa-los na porta. 💧</tspan>
...
<article class="contenedor-fa">
  ...
  <p> O vírus pode se espalhar pela boca ou pelo nariz de uma pessoa infectada, em pequenas partículas líquidas expelidas quando elas tossem, espirram, falam, cantam ou respiram.</p>
  <br>
  <p> Se quiser saber mais sobre o coronavírus clique no botão abaixo.</p> 
  <br>
  <br>
  <br>
  <br>
...
<!--Vacinas-->
  ...
  <center>  
    ...
    <h2 style="color:rgb(7, 114, 185)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Vacinas</h2>
    <br>
    <hr>
    <br>
    <!-- JANSSEN-->
    <article class="contet-fz">
    <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Janssen</h4>
    <br>
    <p> Tecnologia: Vetor viral.</p>
    <p> Eficácia: 66,9% casos leves e moderados, 76,7% contra casos graves.</p>
    <p> Intervalo entre as doses: Dose única.</p>
    <p> Armazenamento: De 2 a 8ºC.</p>
    <p> Voluntários: 7,5 mil pessoas.</p>
      <br>
      <br>
  ...
  <article class="contenedor-fx"> 
    <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;  Pfizer</h4>
    <br>
    <p> Tecnologia: RNA mensageiro.</p>
    <p> Eficácia: 95% após a segunda dose.</p>
    <p> Intervalo entre as doses: Até 12 semanas após a primeira dose.</p>	
    <p> Armazenamento: Até 5 dias em temp de 2 a 8°C, -25 e -15ºC por até 2 semanas e -90 e -60ºC após este período.</p>
    <p> Voluntários: 2 mil pessoas.</p>
    <br>
    </article>
    ...
    <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Astrazenaca
    </h4>
    <br>
    <p> Tecnologia: Vetor viral.
    <p> Eficácia: 76% após a primeira dose e 81% após a segunda.</p>
    <p> Intervalo entre as doses: 12 semanas.</p>
    <p> Armazenamento: De 2 a 8ºC.</p>
    <p> Voluntários: 10 mil pessoas. </p>
    </article>

    <!--CORONAVAC-->
    <article class="contenedor-fm"> 
      <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Coronavac
      </h4>
      <br>
      <p> Tecnologia: Vírus inativado.</p>
      <p> Eficácia: 62,3% caso intervalo seja igualnou superior a 21 dias, 83,7% a 100% com assistência médica. </p>
        <p>Intervalo entre as doses: 14 a 28 dias.</p>
        <p>Armazenamento: De 2 a 8°C.</p>
        <p>Voluntários: 12,5 mil pessoas.</p>
      </article>
  <hr>
  </center>
  ...
  <div class="corpo">
    <section class="carrousel">
      <div class="carrousel__wrapper">
        <img src="../Projeto-Final/imagens/covid7.jpg" class="carrousel__wrapper-item" />
        <img src="../Projeto-Final/imagens/covid8.webp" class="carrousel__wrapper-item" />
        <img src="../Projeto-Final/imagens/covid9.jpg" class="carrousel__wrapper-item" />
      </div>
    </section>
    </div>
    <script>
