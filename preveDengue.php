...
<head lang="pt-br">
    ...
    <title>Espaço Saúde|Prevenção de dengue</title>
    <meta name='viewport' content='width=device-width, initial-scale=1'>
    <link rel='stylesheet' type='text/css' media='screen' href='css/styleDp.css' href="js/menupreve1.js"> <!--CSS da página -->
 ...
 <body>
            ...
            <!--Nome do site e slogan -->
              ...
              <h1 class="fundo-letra">Prevenção ao Mosquito</h1>
...
<center>                                                        
  ...
  <br>
  <p> Procure atendimento médico se tiver febre, dores musculares e manchas avermelhadas.</p> <p>Ligue com antecedência para o órgão prestador de cuidados de saúde e 
    peça direcionamento à unidade mais adequada. Isso protege você e evita a propagação de vírus e outras infecções.</p>
    <br>
    <br>
...
<article class="contenedor-fg"> 
  <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;  Prevenir-se</h4>
  <br>
  <p> A dengue é uma doença sem tratamento específico, sendo recomendado basicamente descanso e hidratação.</p><p> Diante disso, o melhor é prevenir-se da doença. Todas as alternativas abaixo relacionam-se com a prevenção da dengue, exceto: Limpar caixas d'água e mantê-las fechadas para evitar proliferação do mosquito.</p>
  <br>
  </article>


  <!--Dengue-->
  <article class="contenedor-fc"> 
  <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Dengue
  </h4>
  <br>
  <p>  Há quatro tipos de vírus da dengue: Den-1, Den-2, Den-3 e a Den-4. Eles pertencem à família Flaviridae e são vírus que só contêm RNA.</p><p> Eles são da mesma família do vírus que causa a febre amarela, e tanto a dengue quanto a febre amarela são transmitidas pelo mesmo mosquito, o Aedes aegypti.
</p>
  </article>
...
<div class="container">
  <svg id="circle-nav-services" width="100%" height="100%" viewBox="0 0 650 550">
    ...
    <symbol id="circle-nav-copy" viewBox="0 0 300 300">
      ...
      <!--Menu prevenção dengue text dos elementos circle-->
      <title>Prevenção contra o vírus</title>

       <!--Profissional-->
      <text class="cls-1" transform="translate(99 1865)">
        <tspan class="cls-2" x="18" y="0"></tspan>
        <tspan x="28" y="0"></tspan>
        <tspan class="cls-3" x="-55" y="28">Acompanhamento</tspan>
        <tspan x="-4" y="28"></tspan>
        <tspan class="cls-4" x="12" y="28"></tspan>
        <tspan x="21" y="28"></tspan>
      </text>
      <text class="cls-5" transform="translate(30 1930)">Permita sempre o acesso do agente de
        <tspan class="cls-6" x="38" y="0"></tspan>
        <tspan x="43" y="0"> </tspan>
        <tspan class="cls-3" x="1" y="19">zoonoses em sua residência ou estabe- </tspan>
        ...
        <tspan x="1" y="38">lecimento comercial. 👨‍⚕️</tspan>
        <tspan class="cls-8" x="17" y="38"></tspan>
      ...
      <text class="cls-1" transform="translate(89 1566)">
        <tspan class="cls-12"></tspan>
        <tspan x="16" y="0"></tspan>
        <tspan x="0" y="28">Atencioso</tspan>
        <tspan class="cls-10" x="39" y="28"></tspan>
        <tspan x="49" y="28"></tspan>
      </text>
      <text class="cls-5" transform="translate(38 1636)">
        <tspan class="cls-13">Entregue pneus velhos ao serviço de</tspan>
        <tspan x="14" y="0"></tspan>
        <tspan class="cls-7" x="61" y="0"></tspan>
        <tspan x="66" y="0"> </tspan>
        <tspan class="cls-11" x="110" y="0"></tspan>
        <tspan x="118" y="0"></tspan>
        <tspan class="cls-6" x="154" y="0"></tspan>
        <tspan x="159" y="0"> </tspan>
        <tspan x="0" y="19">limpeza urbana, caso precise mantê-  </tspan>
        <tspan x="0" y="38">los , guarde em local coberto. ❗ </tspan>
        <tspan x="0" y="58">Fique em casa se você sentir mal. </tspan>
        <tspan class="cls-14" x="7" y="58"></tspan>
        <tspan x="13" y="58"></tspan>
      </text>
      ...
      <text class="cls-1" transform="translate(105 966)">
        <tspan class="cls-2" x="18" y="0"></tspan>
        <tspan x="28" y="0"></tspan>
        <tspan x="-5" y="28">Piscinas</tspan>
      </text>
      <text class="cls-5" transform="translate(65 1037)">
        <tspan class="cls-13"></tspan>
        <tspan x="-30" y="0">Mantenha a água da piscina sempre </tspan>
        <tspan class="cls-11" x="61" y="0"></tspan>
        <tspan x="68" y="0"></tspan>
        <tspan class="cls-8" x="122" y="0"></tspan>
        <tspan x="127" y="0"> </tspan>
        <tspan x="-30" y="19"> tratada com cloro e limpe-a uma vez</tspan>
        <tspan class="cls-6" x="93" y="19"></tspan>
        <tspan x="98" y="19"> </tspan>
        <tspan x="-30" y="38">por semana. Se não for usá-la, evite</tspan>
        <tspan x="-30" y="58">com lonas ou plásticos. 🏊‍♀️</tspan>
        <tspan class="cls-7" x="80" y="58"></tspan>
        <tspan x="85" y="58"></tspan>
        <tspan class="cls-7" x="116" y="58"></tspan>
        <tspan x="121" y="58"></tspan>
      </text>

      <!--Casa-->
      <text class="cls-1" transform="translate(85 666)">Residência</text>
      <text class="cls-5" transform="translate(83 710)">
        <tspan class="cls-7" x="-34" y="0">Limpe frequentemente as calhas</tspan>
        <tspan x="42" y="0"> </tspan>
        <tspan x="-34" y="19">e a laje das casas, coloque areia </tspan>
        <tspan class="cls-6" x="-18" y="19"></tspan>
        <tspan x="-13" y="19"> </tspan>
        <tspan x="-34" y="38">nos cacos de vidro no muro que</tspan>
        <tspan class="cls-11" x="129" y="38"></tspan>
        <tspan class="cls-15" x="138" y="38"></tspan>
        <tspan x="145" y="38"> </tspan>
        <tspan x="-34" y="58">possam acumular água. 🏠 </tspan>
        <tspan x="-27" y="77"></tspan>
        <tspan class="cls-7" x="136" y="77"></tspan>
        <tspan x="141" y="77"> </tspan>
        <tspan x="-27" y="96"> </tspan>
        <tspan class="cls-6" x="90" y="96"></tspan>
        <tspan x="95" y="96"></tspan>
        <tspan class="cls-8" x="113" y="96"></tspan>
        <tspan x="118" y="96"></tspan>
      </text>

      <!--Depositos-->
      <text class="cls-1" transform="translate(90 70)">Depositos</text>
      <text class="cls-5" transform="translate(35 108)"> Deixe sempre bem tampados e lave
        <tspan x="1" y="19">com bucha e sabão as paredes inter-</tspan>
        <tspan class="cls-6" x="71" y="19"></tspan>
        <tspan x="90" y="19"></tspan>
        <tspan class="cls-8" x="-1" y="38"></tspan>
        <tspan x="1" y="38">nas de caixas de água, poços, cacim- </tspan>
        <tspan x="1" y="58">bas, tambores de água ou tonéis,</tspan>
        <tspan class="cls-9" x="59" y="58"></tspan>
        <tspan x="64" y="58"></tspan>
        <tspan class="cls-6" x="170" y="58"></tspan>
        <tspan x="175" y="58"></tspan>
        <tspan class="cls-16" x="184" y="58"></tspan>
        <tspan x="189" y="58"> </tspan>
        <tspan class="cls-6" x="3" y="77"></tspan>
        <tspan x="1" y="77"> cisternas e filtro. </tspan>
        <tspan class="cls-15" x="8" y="96"></tspan>
        <tspan class="cls-11" x="16" y="96"></tspan>
        <tspan x="24" y="96"></tspan>
      </text>

      <!--Pets-->
      <text class="cls-1" transform="translate(87 365)">
        <tspan class="cls-17"></tspan>
        <tspan x="10" y="0">Animais</tspan>
        <tspan x="-8" y="28">Domésticos</tspan>
        <tspan class="cls-18" x="130" y="28"></tspan>
        <tspan x="149" y="28"></tspan>
      </text>
      <text class="cls-5" transform="translate(40 437)"> Lave e troque a água dos bebedouro
        <tspan class="cls-19" x="40" y="0"></tspan>
        <tspan x="46" y="0"></tspan>
        <tspan class="cls-19" x="173" y="0"></tspan>
        <tspan x="178" y="0"> </tspan>
        <tspan x="1" y="19">de aves e animais no mínimo uma  </tspan>
        <tspan class="cls-6" x="34" y="19"></tspan>
        <tspan class="cls-11" x="39" y="19"></tspan>
        <tspan x="48" y="19"></tspan>
        <tspan x="0" y="38">vez por semana.  🐈 </tspan>
        <tspan x="2" y="58"></tspan>
        <tspan class="cls-17" x="59" y="58"></tspan>
        <tspan x="69" y="58"></tspan>
      </text>
      ...
      <text class="cls-1" transform="translate(138 1266)">
        ...
        <tspan x="-65" y="10">Higienização</tspan>
      </text>
      <text class="cls-5" transform="translate(38 1323)">Não deixe água parada,  destruindo
        <tspan class="cls-6" x="146" y="0"></tspan>
        <tspan x="154" y="0"></tspan>
        <tspan x="0" y="19">os locais onde o mosquito nasce e </tspan>
        <tspan x="0" y="38">se desenvolve, evita sua procriação. </tspan>
        <tspan class="cls-7" x="0" y="58"> </tspan>
        <tspan x="0" y="58"> </tspan>
        <tspan x="-1" y="77">Não deixe acumular água em pratos </tspan>
        <tspan x="0" y="96">de vasos de plantas e xaxins. 💧</tspan>
        <tspan class="cls-15" x="44" y="96"></tspan>
        <tspan x="60" y="96"> </tspan>
      </text>
    </symbol>
...
var services_data = [{ name: "Itens", icon_size }, { name: "Pets", icon_size }, { name: "Casa", icon_size }, { name: "Piscina", icon_size }, { name: "Água", icon_size }, { name: "Cautela", icon_size }, { name: "Especialista", icon_size}];
...
<!--Como se espalha-->
<h2  style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Como ela se espalha </h2>
<article class="contenedor-fa">

  <p> A fêmea do mosquito deposita seus ovos nas bordas dos recipientes com água limpa e parada. Dois ou três dias após o contato com o líquido, os ovos viram larvas e dias depois chegam na fase da pupa. Esse ciclo dura cerca de 48 horas e, ao término, se transformam em mosquitos adultos.
</p>
  <br>
  <p> Se quiser saber mais sobre o mosquito clique no botão abaixo.</p> 
  <br>
  <br>
  <br>
  <br>
...
<!--Dicas-->
  ...
  <center>  
    ...
    <h2 style="color:rgb(7, 114, 185)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Dicas</h2>
    <br>
    <hr>
    <br>
    <!-- Cautela-->
    <article class="contet-fz">
    <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Cautela</h4>
    <br>
    <p> Mantenha o quintal limpo, recolhendo o lixo e detritos em volta das casas, limpando os latões e mantendo as lixeiras tampadas. Não jogue lixo em terrenos baldios, construções e praças. </p>
    <p>Chame a limpeza urbana quando necessário.</p>
      <br>
      <br>
     ...
     <!--Água-->
  <article class="contenedor-fx"> 
    <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;  Água</h4>
    <br>
    <p> Mantenha sempre limpo: lagos, cascatas e espelhos d'água decorativos. </p><p>Crie peixes nesses locais, eles se alimentam das larvas dos mosquitos.</p>
    <br>
    </article>
  
  
    <!--Reciclar-->
    <article class="contenedor-fj"> 
    <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Reciclar
    </h4>
    <br>
    <p> Não junte vasilhas e utensílios que possam acumular água (tampinha de garrafa, casca de ovo, latinha, saquinho plástico de cigarro, embalagem plástica e de vidro, copo descartável etc).</p>
    <p>Guarde garrafas vazias de cabeça para baixo.</p>
    </article>

    <!--Plantas-->
    <article class="contenedor-fm"> 
      <h4 style="color:rgb(5,119,196)">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160; Plantas
      </h4>
      <br>
      <p> Plantas que possam acumular água devem ser tratadas com água sanitária na proporção de uma colher de sopa para um litro de água, regando no mínimo, duas vezes por semana.</p>
        <p>Tire sempre a água acumulada nas folhas.</p>
      </article>
  <hr>
  </center>
...
.carrousel__wrapper {
  ...
  position: absolute; 
	...
	top: 1660px; /* posiciona a 70px para baixo */
}
  ...
  <div class="corpo">
    <section class="carrousel">
      <div class="carrousel__wrapper">
        <img src="../Projeto-Final/imagens/dengue5.jpg" class="carrousel__wrapper-item" />
        <img src="../Projeto-Final/imagens/dengue6.jpg" class="carrousel__wrapper-item" />
        <img src="../Projeto-Final/imagens/dengue7.jpg" class="carrousel__wrapper-item" />
      </div>
    </section>
    </div>
    <script>
